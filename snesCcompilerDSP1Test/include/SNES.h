...
// MSU1 Read Registers
#define MSU_STATUS    (*(vu8*)0x2000)     // MSU1 Status Register         1B/R 
#define MSU_READ      (*(vu8*)0x2001)     // MSU1 Read Register           1B/R
#define MSU_ID        (*(vu8*)0x2002)     // MSU1 ID Register ("S-MSU1")  6B/R

// MSU1 Write Registers
#define MSU_SEEK      (*(vu16*)0x2000)	   // MSU1 Seek Register          2B/W
#define MSU_SEEKBANK  (*(vu16*)0x2002)	   // MSU1 Seek Bank Register     2B/W
#define MSU_TRACK     (*(vu16*)0x2004)     // MSU1 Seek Bank Register     2B/W
#define MSU_VOLUME    (*(vu8*)0x2006)     // MSU1 Volume Register         1B/W
#define MSU_CONTROL   (*(vu8*)0x2007)     // MSU1 Control Register        1B/W

//LoROM DSP1 ports
#define DSP1_DR_8   (*(vu8*)0xBF8000)
#define DSP1_SR_8   (*(vu8*)0xBFC000)
#define DSP1_DR_16  (*(vu16*)0xBF8000)
#define DSP1_SR_16  (*(vu16*)0xBFC000)
