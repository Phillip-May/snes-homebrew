...
vc +snes-hi -lm -maxoptpasses=300 -O4 -inline-depth=1000 -unroll-all -fp-associative -force-statics -range-opt src\mainBankZero.c  src\celesteSimple.c src\libfixmath\fix16.c shared\src\initsnes.c -o build/vbcc.smc
