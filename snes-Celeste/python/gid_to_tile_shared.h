...
__attribute__((section(".prg_rom_5"))) const unsigned char gid_to_tile_shared[63][6] = {
#else
const unsigned char gid_to_tile_shared[63][6] = {
#endif
    // GID 0
    { 0, 0, 0, 0, 0, 0 },
    // GID 1
...
#define GID_TO_TILE_SHARED_COUNT 63
