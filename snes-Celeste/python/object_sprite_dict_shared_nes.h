...
const unsigned char object_sprite_dict_compact[19][5] = {
    ...
    /* compact_idx 10: tile 18 */  { 0, 46, 47, 48, 49 },
    /* compact_idx 11: tile 19 */  { 0, 0, 0, 46, 47 },
    /* compact_idx 12: tile 20 */  { 0, 50, 51, 52, 53 },
    /* compact_idx 13: tile 22 */  { 0, 56, 57, 58, 59 },
    /* compact_idx 14: tile 23 */  { 1, 60, 61, 62, 63 },
    /* compact_idx 15: tile 24 */  { 1, 64, 65, 66, 67 },
    /* compact_idx 16: tile 25 */  { 1, 68, 69, 70, 71 },
    /* compact_idx 17: tile 26 */  { 0, 72, 55, 73, 74 },
    /* compact_idx 18: tile 28 */  { 0, 77, 78, 79, 80 }
};

#define OBJECT_SPRITE_DICT_LOOKUP_TABLE_SIZE 33
#define OBJECT_SPRITE_DICT_COMPACT_COUNT 19
