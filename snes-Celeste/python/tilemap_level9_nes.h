...
// Tilemap data for layer 'level9' (GIDs, one byte per entry)
const unsigned char tilemap_level9[] = {
    3, 5, 6, 0, 0, 0, 7, 5, 5, 5, 5, 5, 5, 5, 3, 3,
    21, 9, 9, 0, 0, 0, 28, 0, 13, 9, 9, 9, 9, 9, 7, 3,
    6, 9, 17, 0, 0, 0, 29, 0, 0, 13, 12, 9, 0, 13, 7, 3,
    9, 9, 11, 8, 0, 0, 0, 0, 0, 0, 9, 9, 17, 0, 7, 4,
    9, 9, 9, 0, 0, 0, 0, 0, 0, 13, 9, 9, 9, 0, 7, 3,
    9, 12, 9, 0, 0, 0, 0, 0, 0, 0, 16, 9, 8, 0, 7, 3,
    9, 9, 9, 23, 24, 0, 0, 0, 24, 31, 9, 12, 0, 0, 2, 5,
    9, 9, 9, 9, 11, 8, 0, 0, 0, 13, 9, 9, 23, 0, 0, 9,
    9, 8, 0, 0, 13, 0, 0, 0, 0, 0, 12, 13, 8, 0, 16, 9,
    9, 16, 0, 0, 0, 0, 0, 0, 0, 0, 9, 0, 0, 0, 9, 9,
    12, 8, 0, 0, 0, 0, 0, 0, 0, 16, 11, 8, 0, 0, 9, 12,
    8, 0, 0, 0, 0, 0, 0, 0, 0, 0, 13, 0, 0, 0, 9, 8,
    0, 0, 0, 0, 0, 0, 27, 27, 27, 0, 0, 0, 0, 0, 13, 16,
    27, 27, 10, 27, 27, 27, 26, 20, 1, 0, 0, 0, 0, 0, 0, 13,
    20, 20, 20, 20, 20, 1, 7, 4, 21, 27, 27, 27, 10, 10, 27, 27,
    3, 4, 3, 3, 3, 21, 7, 3, 21, 26, 20, 20, 20, 20, 20, 20
};
