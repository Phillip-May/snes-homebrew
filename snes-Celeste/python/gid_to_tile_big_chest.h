...
const unsigned char gid_to_tile_big_chest[1][18] = {
    ...
    // 4x4 grid: Row 1: 226, 227, 227, 229 | Row 2: 228, 228, 228, 228 | Row 3: 244, 245, 248, 249 | Row 4: 246, 247, 250, 251
    { 226, 227, 227, 229, 228, 228, 228, 228, 244, 245, 248, 249, 246, 247, 250, 251, 0, 0 }
};
