...
const unsigned char gid_to_tile_big_chest[1][18] = {
    ...
    // 4x4 grid: Row 1: 227, 228, 228, 229 | Row 2: 116, 116, 116, 116 | Row 3: 244, 245, 248, 249 | Row 4: 246, 247, 250, 251
    { 227, 228, 228, 229, 116, 116, 116, 116, 244, 245, 248, 249, 246, 247, 250, 251, 0, 0 }
};
