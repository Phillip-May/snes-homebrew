...
local out = "C:/Users/Admin/Documents/snes-homebrew/snes-Celeste/build/debug_skip_room8_result.txt"
...
emu.addEventCallback(function()
    ...
    elseif frame == 420 or frame == 450 or frame == 480 or frame == 510 or frame == 540 or frame == 570 or frame == 600 then
        set_pad({ r = true })
    else
        set_pad({})
    end
