...
local outPng = "C:/Users/Admin/Documents/snes-homebrew/snes-Celeste/build/monument_screenshot.png"
local outTxt = "C:/Users/Admin/Documents/snes-homebrew/snes-Celeste/build/monument_screenshot_result.txt"
...
emu.addEventCallback(function()
    ...
    if roomHitFrame ~= nil and (frame - roomHitFrame) >= 850 then
        writePng(emu.takeScreenshot())
        log(string.format("SHOT frame=%d fc=%d room=%d", frame, fc, room))
        flush()
        done = true
