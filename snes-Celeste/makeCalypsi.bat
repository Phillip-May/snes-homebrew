...
cc65816 --core=65816 -O2 --speed --code-model=large --data-model=large --list-file=build/calypsi.lst -o build/initsnes.o shared/src/initsnes.c
...
cc65816 --code-model=large --data-model=large shared/src/initsnes.c -o build/initsnes.o
